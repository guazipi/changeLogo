...
function main() {
    var scene, camera, webglRender, stats, f = !1, g, l = function (a) {
        f = !1
    }, m = function (a) {
        f = !0;
        g = a.clientX
...
function smallerLogo() {
    if (void 0 != logoMesh) {
        for (var b = 0; b != uvarr.length; ++b)for (var c = uvarr[b], a = 0; a != c.length; ++a) {
            var d = c[a];
            d.x = 2 * d.x - .5;
            d.y = 2 * d.y - .5
        }
...
function moveLeft() {
    if (void 0 != logoMesh) {
        for (var b = 0; b != uvarr.length; ++b)for (var c = uvarr[b], a = 0; a != c.length; ++a)c[a].x += .1;
        geo.uvsNeedUpdate = !0
    }
}
function moveRight() {
...
function moveTop() {
    if (void 0 != logoMesh) {
        for (var b = 0; b != uvarr.length; ++b)for (var c = uvarr[b], a = 0; a != c.length; ++a)c[a].y -= .1;
        geo.uvsNeedUpdate = !0
    }
}
function moveBottom() {
